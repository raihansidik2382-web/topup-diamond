...
@section('content')
    ...
    <form action="{{ route('admin.games.store') }}" method="POST" class="max-w-lg">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cover" id="cover" value="{{ old('cover') }}" placeholder="nama-file-cover.jpg" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] placeholder-muted focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30">
