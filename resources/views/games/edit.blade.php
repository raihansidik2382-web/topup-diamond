...
@section('content')
    ...
    <form action="{{ route('admin.games.update', $game) }}" method="POST" class="max-w-lg">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="icon" id="icon" value="{{ old('icon', $game->icon) }}" placeholder="nama-file.png" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
