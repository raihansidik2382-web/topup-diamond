...
@section('content')
    <h1 class="text-2xl font-black uppercase tracking-[0.15em] mb-6">Edit Pesanan</h1>
    ...
    <form action="{{ route('admin.orders.update', $order) }}" method="POST" class="max-w-lg">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name', $order->customer_name) }}" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] placeholder-muted focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
        ...
        <div class="mb-4">
            ...
            <input type="email" name="customer_email" id="customer_email" value="{{ old('customer_email', $order->customer_email) }}" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] placeholder-muted focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
        ...
        <div class="mb-4">
            ...
            <select name="game_id" id="game_id" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
                ...
                @foreach ($games as $game)
                    <option value="{{ $game->id }}" {{ old('game_id', $order->game_id) == $game->id ? 'selected' : '' }} class="bg-navy-dark">{{ $game->name }}</option>
                @endforeach
            </select>
        ...
        <div class="mb-4">
            ...
            <select name="product_id" id="product_id" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
                ...
                @foreach ($products as $product)
                    <option value="{{ $product->id }}" {{ old('product_id', $order->product_id) == $product->id ? 'selected' : '' }} class="bg-navy-dark">{{ $product->name }} - {{ $product->formatted_price }}</option>
                @endforeach
            </select>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="player_id" id="player_id" value="{{ old('player_id', $order->player_id) }}" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] placeholder-muted focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="server_id" id="server_id" value="{{ old('server_id', $order->server_id) }}" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] placeholder-muted focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="amount" id="amount" value="{{ old('amount', $order->amount) }}" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] placeholder-muted focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
        ...
        <div class="mb-4">
            ...
            <select name="payment_method" id="payment_method" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30">
                ...
                <option value="transfer" {{ old('payment_method', $order->payment_method) == 'transfer' ? 'selected' : '' }} class="bg-navy-dark">Transfer Bank</option>
                <option value="e-wallet" {{ old('payment_method', $order->payment_method) == 'e-wallet' ? 'selected' : '' }} class="bg-navy-dark">E-Wallet</option>
                <option value="convenience_store" {{ old('payment_method', $order->payment_method) == 'convenience_store' ? 'selected' : '' }} class="bg-navy-dark">Convenience Store</option>
            </select>
        ...
        <div class="mb-6">
            ...
            <select name="status" id="status" class="block w-full rounded-lg bg-navy-light border border-white/5 px-3 py-2 text-sm text-[#f5f5f5] focus:outline-none focus:border-orange-accent focus:ring-1 focus:ring-orange-accent/30" required>
                <option value="pending" {{ old('status', $order->status) == 'pending' ? 'selected' : '' }} class="bg-navy-dark">Pending</option>
                <option value="success" {{ old('status', $order->status) == 'success' ? 'selected' : '' }} class="bg-navy-dark">Sukses</option>
                <option value="failed" {{ old('status', $order->status) == 'failed' ? 'selected' : '' }} class="bg-navy-dark">Gagal</option>
            </select>
