...
@section('content')
    <h1 class="text-2xl font-semibold mb-6">Tambah Pesanan</h1>
    ...
    <form action="{{ route('admin.orders.store') }}" method="POST" class="max-w-lg">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name') }}" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" required>
        ...
        <div class="mb-4">
            ...
            <input type="email" name="customer_email" id="customer_email" value="{{ old('customer_email') }}" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="player_id" id="player_id" value="{{ old('player_id') }}" placeholder="123456789" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="server_id" id="server_id" value="{{ old('server_id') }}" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="amount" id="amount" value="{{ old('amount') }}" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" required>
        ...
        <div class="mb-4">
            ...
            <select name="payment_method" id="payment_method" class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                ...
                <option value="convenience_store" {{ old('payment_method') == 'convenience_store' ? 'selected' : '' }}>Convenience Store</option>
            </select>
